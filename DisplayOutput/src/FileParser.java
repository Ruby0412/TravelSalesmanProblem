...
public class FileParser {
	...
	static ArrayList<Double> longlist = new ArrayList<Double>();
	static ArrayList<Double> lalist = new ArrayList<Double>();
...
//	}
	...
	public static double getLongitude(int index) {
		return longlist.get(index);
	}
	
	public static double getatitude(int index) {
		return lalist.get(index);
	}
